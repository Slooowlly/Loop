...
- Com o toggle desligado, não são renderizados os detalhes técnicos da macro, comando de chat, quebra ao vivo, teste do overlay de rádio, gravação de corrida e rivalidades percebidas.
...
2. Todos os seis grupos técnicos atualmente presentes — detalhes, chat, quebra, overlay, gravação e rivalidades — não aparecem no DOM enquanto o toggle está desligado.
3. Clicar no toggle exibe os seis grupos técnicos.
