...
/// regra de ordem das três chamadas da rodada. Em 18/08/2026 foi para 56 com o
/// `unwrap-no-caminho-de-producao`, que põe teto no pânico do Rust que entra no build.
///
