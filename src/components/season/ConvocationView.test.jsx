...
describe("ConvocationView", () => {
  ...
  it("restores category logos and the previous team order inside production and endurance", () => {
    ...
    expect(screen.getByAltText(/production/i)).toHaveAttribute("src", "/utilities/categorias/recortadas/PRODUCTION.webp");
    expect(screen.getByAltText(/endurance/i)).toHaveAttribute("src", "/utilities/categorias/recortadas/ENDURANCE.webp");
