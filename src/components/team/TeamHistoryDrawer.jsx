  ...
  return (
    <section>
      ...
      <div className="mt-4 grid gap-3">
        ...
        <HistoryInfoCard label={t("myTeamTab.history.categories.peakCategory")} value={dossier.movement.peakCategory} />
        <HistoryInfoCard label={t("myTeamTab.history.categories.homeCategory")} value={dossier.movement.homeCategory} />
      </div>
            ...
            <div key={`${step.category}-${index}`} className="rounded-2xl border border-l-4 border-white/12 bg-[#0c1626]/95 p-4" style={{ borderLeftColor: step.color }}>
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-center gap-2">
                  <Tooltip texto={move.label}>
                    <span className={`font-mono text-sm font-black ${move.tone}`}>{move.icon}</span>
                  </Tooltip>
