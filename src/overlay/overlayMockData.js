...
//               Emoji à esquerda do nome — SÓ na torre GRANDE (a mini não mostra).
//   player     é o carro do jogador
//
// O COMPANHEIRO DE EQUIPE não é campo: é derivado (mesmo `team` do jogador). Os DOIS
// carros do seu time têm o nome na COR DA EQUIPE (car.color). Ver towerRows.js/towerCanvas.js.
  ...
  classes: [
    {
      ...
      cars: [
        ...
        // RIVAL (🔥) — emoji à esquerda do nome, só na torre grande.
