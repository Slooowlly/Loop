...
const COMMON = {
  ...
  // os DOIS carros do seu time são marcados por um traço na cor da equipe + leve realce
  // da linha, direto no drawRow. (playerColor mantido só por segurança, sem uso hoje.)
  playerColor: "#3fb950",
